...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2025/09/30 16:02:35 by marcsan2          #+#    #+#              #
#    Updated: 2025/10/21 11:09:02 by marcsan2         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
ft_atoi.c ft_atoi.c ft_calloc.c ft_strdup.c ft_substr.c ft_strjoin.c ft_strtrim.c \
